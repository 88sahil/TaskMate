...
const {createProject,getProjects,DeleteProject,AddTeam,DeleteTeam,AddTag,RemoveTag} = require('../Controllers/projectController')

project.route('/').post(protected,createProject).get(protected,getProjects)
//id route
project.route('/:projectid').delete(DeleteProject)
